...
LABEL io.github.snakemake.conda_env_hash="9e27b5c6485b066a209dfad64e9a509fecd679044d357b38a6d2018ddd9f6617"

# Step 1: Retrieve conda environments

# Conda environment:
#   source: workflow/envs/complex-upset.yml
#   prefix: /conda-envs/e270c0877cb3e0efb097eb3a48bffc5c
#   name: complexUpset
#   channels:
#     - conda-forge
#     - bioconda
...
#     - cctools_osx-64=973.0.1=hb41342b_10
...
#     - r-complexupset=1.3.3=r41hc72bb7e_0
...
#   prefix: /Users/kelly/miniconda3/envs/complexUpset
RUN mkdir -p /conda-envs/e270c0877cb3e0efb097eb3a48bffc5c
COPY workflow/envs/complex-upset.yml /conda-envs/e270c0877cb3e0efb097eb3a48bffc5c/environment.yaml
...
RUN mamba env create --prefix /conda-envs/e270c0877cb3e0efb097eb3a48bffc5c --file /conda-envs/e270c0877cb3e0efb097eb3a48bffc5c/environment.yaml && \
    mamba env create --prefix /conda-envs/6ff87ff01b88a68c415c2b2075c74202 --file /conda-envs/6ff87ff01b88a68c415c2b2075c74202/environment.yaml && \
