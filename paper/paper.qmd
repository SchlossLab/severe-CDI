...
CDI diagnosis to predict attributable severity, yielding an AUROC of `r
ehr_auroc` [@li_using_2019].
...
comparison of the performance of models trained on OTUs, EHRs, or both.
