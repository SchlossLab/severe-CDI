...
protective gut microbiota and allows _C. diff_ to proliferate [@kelly_can_2012].
...
Many factors influence CDI severity, 
however, there is not a consensus on how to
define severity [@ressler_defining_2021]. 
disease-related complications definition [@mcdonald_recommendations_2007].
...
also models on EHR to predict adverse outcomes (Li, Rao ribotype).
...
We chose to explore several different ways to define CDI severity (@fig-flowchart).
