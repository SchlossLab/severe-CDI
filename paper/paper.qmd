...
The steps for machine learning, making figures, and rendering the manuscript
were defined with Snakemake [@koster_snakemake_2012] using a custom version of the
mikropml Snakemake workflow [@sovacool_mikropml_2023].
...
cowplot [@wilke_cowplot_2020], and
vegan [@oksanen_vegan_2022].
