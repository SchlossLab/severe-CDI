...
Some scoring systems such as the IDSA severity score focus on laboratory data
available during the course of CDI, while others focus on adverse outcomes of
CDI at 30 days after diagnosis [@ressler_defining_2021].
...
Performance.
full datasets for best models possible for clinical application.
intersection dataset for comparing severity definitions.
...
e.g. pseudomonas super high variance for attributable, highest point more 
important than any other OTU, but minimum CI crosses zero -- some data splits
are unlucky? could be more important if more data available?
...
tbh gut microbiome may only play a small role.
...
analysis of clinical value could be extended to include costs as well as include
other treatments if evidence of severity prevention emerges.
