...
model trained on EHR data extracted two days after the diagnosis.
...
both model performance and treatment performance [@liu_number_2019].
...
routinely sequencing and profiling the microbial communities of CDI patients
could be justified if models that incorporate microbial features were shown to
...
treatment options promises to reduce morbidity and mortality of CDI.
<!--
