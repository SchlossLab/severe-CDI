...
greater importance.
We plotted log~10~-transformed median relative abundances for the most important
OTUs.
...
The relative abundance of _Enterococcus_ was also elevated in severe cases over
not severe cases for all severity definitions.
...
important in one or two of the models.
For many of the top OTUs, there is wide variance in importance, likely due to
the imbalanced nature of the severity outcomes.
There is not always a clear pattern
of increased or decreased relative abundance of important OTUs in severe cases.
...
Median difference in AUROC is reported for each OTU, with starred OTUs being
significant for a 75% confidence interval.
