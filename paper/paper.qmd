...
---
```{rsetup, eval=TRUE, echo=FALSE, cache=FALSE}
...
missing data for some patient lab values and incomplete chart review (TODO table).
...
#| label: tbl-risk
#| tbl-cap: "**Predictive model performance at 95th percentile of risk.** The confusion matrix was computed at the 95th percentile of risk for each severity prediction model, which corresponds to 5% of cases predicted to be severe."
