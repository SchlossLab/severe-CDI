...
- use values from confusion matrix for one representative model on a test set.
...
- Krishna: bezlotoxumab clinical trials didn't find signal for limiting severity. but fidaxomicin is superior to vancomicin for cure and time to resolution of diarrhea.
...
no significant difference in whether CDI was cured, but did have significant
